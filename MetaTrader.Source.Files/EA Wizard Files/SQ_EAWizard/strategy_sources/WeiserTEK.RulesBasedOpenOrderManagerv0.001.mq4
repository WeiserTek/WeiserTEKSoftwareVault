//+------------------------------------------------------------------+
//| WeiserTEK.RulesBasedOpenOrderManager v0.001 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Mon Apr 15 18:09:00 EDT 2019
//+------------------------------------------------------------------+
...
// -- Variables
//+------------------------------------------------------------------+
extern string Var5 = "----------->> ENABLE SECTION FOR TESTING ONLY <<-------";
extern bool Input_EnableOrderEntyForTestingONLY = true;
extern int Input_ThreeEMATrendDirection_Timeframe = 60;
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "WeiserTEK.RulesBasedOpenOrderManager v0.001 EA", 9, "Tahoma", LabelColor);
...
int start() {
   ...
   // Go Long 
   if(sqIsBarOpen == true) {
      if (((GetTrendFromEMA() == 1) 
      && (sqGetMarketPosition() == 0)))
      {
      sqOpenOrder("NULL", OP_BUY, getOrderSize(1000, OP_BUY ), getOrderPrice(1000), "", 1000, "Go Long");
      }
   }
   //--------------------------------------
   // Go Short 
   if(sqIsBarOpen == true) {
      ...
      && (sqGetMarketPosition() == 0)))
      {
      sqOpenOrder("NULL", OP_SELL, getOrderSize(2000, OP_SELL ), getOrderPrice(2000), "", 2000, "Go Short");
      }
   }
   //--------------------------------------
   // Mange Open Orders 
