...
//|    Generated at Sun Dec 30 23:21:00 EST 2018
//+------------------------------------------------------------------+
...
extern int Input_3EMATrendDirection_Timeframe = 1440;
extern int Input_3EMATrendDirection_Shortest = 8;
extern int Input_3EMATrendDirection_Middle = 13;
extern int Input_3EMATrendDirection_Longest = 21;
int Output_3EMATrendDirection = 0;
extern bool Debug_3EMATrendDirectionOn = true;
...
int start() {
   ...
   if ((Initialized_WaveBreakFlagOn == false))
   {
      ...
      //CreateBreakoutLines(NULL,wbm.WaveBreakTimeframe,0,wbm.WaveBreakPivotPointsToTrack);
...
class BreakoutLineObject{
   ...
   public:
      double OriginPointPrice;
      datetime OriginPointDateTime;
      double AngleDefinitionPointPrice;
      datetime AngleDefinitionPointDateTime;
