//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.002b EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Sat Dec 15 23:25:00 EST 2018
//+------------------------------------------------------------------+
...
extern int Input_WaveBreak_TrianglesCount = 10;
...
bool Initialized_WaveBreak = false;
extern bool Debug_WaveBreak = true;
extern string Var8 = "---------- (1000) 3 EMA Trend Direction -------------------";
extern int Input_3EMATrendDirection_Timeframe_1000 = 1440;
extern int Input_3EMATrendDirection_Shortest_1000 = 8;
extern int Input_3EMATrendDirection_Middle1_1000 = 13;
extern int Input_3EMATrendDirection_Longest_1000 = 21;
int Output_3EMATrendDirection_1000 = 0;
bool Initialized_3EMATrendDirection_1000 = true;
extern bool Debug_3EMATrendDirection_1000 = true;
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.002b EA", 9, "Tahoma", LabelColor);
...
int start() {
   ...
   //--------------------------------------
   // Initialize 
   if ((Initialized_WaveBreak == false))
   {
      // Custom action
      ProcessWaveBreak();
      CreateBreakoutTriangles(NULL,wbm.WaveBreakTimeframe,0,25);
      debugObject.Write();
      debugObject.Clear();
...
class WaveBreakManager{
   public:
      ...
      bool DebugWaveBreakFlag;
   
   WaveBreakManager()
   {
      WaveBreakTimeframe=Input_WaveBreak_Timeframe;
      WaveBreakDebugFlagOn=Debug_WaveBreak;
      WaveBreakPivotPointsToTrack=Input_WaveBreakPivotPointsToTrack;
      EMATrendDirectionDebugOn==Debug_3EMATrendDirectionOn;
   }
};
...
void ProcessWaveBreak()
{
   ...
   if(Initialized_WaveBreak==false){DeleteAllObjectsByPrefix("PTT");}
...
void CreateBreakoutTriangles(string symbol,int timeFrame,int startPivotIndex,int endPivotIndex)
{
   ...
   for(int tIndex = 1;tIndex<=wbm.WaveBreakPivotPointsToTrack-2;tIndex++)
   {
      trend = 0;
      ...
      if(trend ==1){lineColor = PaleGreen;}
      if(trend == -1){lineColor = Pink;}
...
WavePointClusterObject wpco[101];
PivotPointObject ppo[101];
