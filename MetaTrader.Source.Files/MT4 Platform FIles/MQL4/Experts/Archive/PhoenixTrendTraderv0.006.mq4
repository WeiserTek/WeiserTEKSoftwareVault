//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.006 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Wed Jan 09 19:21:00 EST 2019
//+------------------------------------------------------------------+
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.006 EA", 9, "Tahoma", LabelColor);
...
//+------------------------------------------------------------------------------------------+
//+ Phoenix Trend Trader Library v0.006
//+
//+------------------------------------------------------------------------------------------+
//
...
void UpdateRobotManagers()
{
   ...
   {
      stopPrice = GetLowestPriceOfOpenClose(NULL,wbm.WaveBreakTimeframe,1);
      MoveStopsOnAllOpenOrders(stopPrice,true);   
   }
   
   if(wboem.TradeDirection==directionByIntValue.ShortIntValue)
   {
      stopPrice = GetHighestPriceOfOpenClose(NULL,wbm.WaveBreakTimeframe,1);
      MoveStopsOnAllOpenOrders(stopPrice,true);   
   }
...
void UpdateWaveBreakOrderEntryManager()
{
   ...
   VerboseLog("Current Open In Position Flag: ", GetCurrentOpenInPositionFlag());
