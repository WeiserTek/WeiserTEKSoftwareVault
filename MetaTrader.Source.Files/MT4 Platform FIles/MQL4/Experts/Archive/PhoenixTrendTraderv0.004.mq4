//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.004 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Sat Jan 05 17:03:00 EST 2019
//+------------------------------------------------------------------+
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.004 EA", 9, "Tahoma", LabelColor);
...
//+------------------------------------------------------------------------------------------+
//+ Phoenix Trend Trader Library v0.004
//+
//+------------------------------------------------------------------------------------------+
//
...
class WaveBreakOrderEntryManager{
   public:
      int TripleMovingAveragesTrend; 
      int WaveBreakTriangleTrend;
      double CurrentBreakOutPrice;
      bool OkayToEnterTradeFlag;  
   
   WaveBreakOrderEntryManager()
   {
      TripleMovingAveragesTrend = directionByIntValue.NeutralIntValue;
      WaveBreakTriangleTrend= directionByIntValue.NeutralIntValue;
      OkayToEnterTradeFlag = false;
   }
...
class TripleEMAMovingAverageManager{
   public:
      ...
      bool ThreeEMATrendDirectionFlagOn;
...
void UpdateWaveBreakOrderEntryManager()
{
   ...
   wboem.WaveBreakTriangleTrend = tboo[0].TriangleDirection;
   //wboem.TripleMovingAveragesTrend = Get
   //wboem.CurrentBreakOutPrice
   //wboem.OkayToEnterTradeFlag
   //wboem.TripleMovingAveragesTrend;
}
...
void CreateBreakoutTriangles(string symbol,int timeFrame,int startPivotIndex,int endPivotIndex)
{
   ...
   for(int tIndex = 1;tIndex<=endPivotIndex-2;tIndex++)
   {
      ...
      if(trend != directionByIntValue.NeutralIntValue)
      {
         ...
         {
            debugObject.Add("(x1,y1): ("+bolo[triangleIndex].x1+","+bolo[triangleIndex].y1+") (x2,y2): ("+bolo[triangleIndex].x2+","+bolo[triangleIndex].y2+") (x3,y3): ("+bolo[triangleIndex].x3+","+bolo[triangleIndex].y3+") slope: "+bolo[triangleIndex].m+" b: "+bolo[triangleIndex].b+" y=mx+b: y="+bolo[triangleIndex].m+"x+"+bolo[triangleIndex].b + " Destination Bar: " + bolo[triangleIndex].x2 + "\n");   
         }  
