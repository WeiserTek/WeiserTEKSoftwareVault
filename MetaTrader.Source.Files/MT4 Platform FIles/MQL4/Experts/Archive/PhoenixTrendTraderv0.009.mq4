//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.009 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Fri Jan 25 22:58:00 EST 2019
//+------------------------------------------------------------------+
...
extern bool Debug_ClusterObjectDebugFlagOn = true;
extern bool Debug_PivotBarDebugFlagOn = true;
extern bool Debug_TriangleBreakoutDebugFlagOn = true;
extern bool Debug_BreakoutLineDebugFlagOn = true;
extern bool Debug_BreakoutLinePriceDebugFlagOn = true;
extern bool Debug_ThreeEMATrendDirectionFlagOn = true;
extern bool Debug_CurrentTriangleBreakoutDirectionFlagOn = true;
extern bool Debug_WaveBreakOrderEntryManagerFlagOn = true;
extern string Var32 = ">>>>>>>>>> ROBOT CONTROLS >>>>>>>";
extern bool ThreeEMATrendDirectionEnabled = true;
extern bool BreakoutPriceFlagEnabled = true;
extern bool TriangleBreakoutDirectionEnabled = true;
extern bool CurrentOpenInPositionFlagEnabled = true;
extern bool CurrentCandleColorCorrectFlagEnabled = true;
extern bool PreviousCandleColorCorrectFlagEnabled = true;
extern bool TrianglePointOneNotVioloatedFlagOnEnabled = true;
extern bool PriceExtremeReachedFlagEnabled = true;
extern bool PivotLineTypeEnabled = true;
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.009 EA", 9, "Tahoma", LabelColor);
...
int start() {
   ...
   {
      sqOpenOrder("NULL", OP_BUY, getOrderSize(1000, OP_BUY ), getOrderPrice(1000), "", 1000, "Okay To Go Long");
   }
   //--------------------------------------
   // Okay To Go Short 
   if (((sqGetMarketPosition() == 0) 
      && (GetOrderEntryDirection() == (-1))))
   {
      sqOpenOrder("NULL", OP_SELL, getOrderSize(2000, OP_SELL ), getOrderPrice(2000), "", 2000, "Okay To Go Short");
   }
   //--------------------------------------
   // End of Tick Cleanup 
   if ((0 == 0))
...
//+------------------------------------------------------------------------------------------+
//+ Phoenix Trend Trader Library v0.009
//+
//+------------------------------------------------------------------------------------------+
//
...
class WaveBreakOrderEntryManager{
   public:
      ...
      bool CurrentOpenInPositionFlag;
      ...
      bool TrianglePointOneNotViolatedFlagOn;
      bool PriceExtremeReachedFlag;
   ...
   WaveBreakOrderEntryManager()
   {
      ...
      CurrentOpenInPositionFlag=false;
      ...
      TrianglePointOneNotViolatedFlagOn=false;
      PriceExtremeReachedFlag=false;
   }
...
{
   VerboseLog("UpdateRobotManagers()");
...
void UpdateTripleEMAMovingAverageManager()
{
   ...
   //VerboseLog("Debug On: " + temamam.ThreeEMATrendDirectionDebugFlagOn + " EMA Trend: ", temamam.ThreeEMATrendDirection);
   ...
   if(temamam.ThreeEMATrendDirectionDebugFlagOn)
   {
      ...
      (
         ...
         "Shortest Period: " + temamam.ThreeEMATrendDirection_Shortest + " " +
         "Middle Period: " + temamam.ThreeEMATrendDirection_Middle + " " +
         "Longest Period: " + temamam.ThreeEMATrendDirection_Longest + " " +
...
{
   ctbod.TriangleDirection = tboo[0].TriangleDirection;
...
int GetTrendFromEMA()
{
   ...
   {
      double EMA1 = GetEMA(temamam.ThreeEMATrendDirection_Timeframe,temamam.ThreeEMATrendDirection_Shortest,shift);
      double EMA2 = GetEMA(temamam.ThreeEMATrendDirection_Timeframe,temamam.ThreeEMATrendDirection_Middle,shift);
      double EMA3 = GetEMA(temamam.ThreeEMATrendDirection_Timeframe,temamam.ThreeEMATrendDirection_Longest,shift);
      
      VerboseLog("Shift: ",shift," EMA1: ",EMA1," EMA2: ",EMA2, " EMA3: ",EMA3);
   ...
   if(trendSum=3){trend=directionByIntValue.LongIntValue;}
   if(trendSum=-3){trend=directionByIntValue.ShortIntValue;}
   
   VerboseLog("Trend Sum: " + trendSum);
   
   return(trend);      
}

bool GetCurrentOpenInPositionFlag()
{
   bool flag = false;
...
bool GetPriceExtremeReachedFlag()
{
   bool flag=false;
   
   //VerboseLog("Long Check - Close[0]: " + Close[0] + " Highest Price: " + GetHighestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[0].Bar1));
   //VerboseLog("Short Check - Close[0]: " + Close[0] + " Lowest Price: " + GetLowestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[0].Bar1));
   
   if(wboem.TriangleBreakoutDirection==directionByIntValue.LongIntValue)
   {
      if(Close[0] > GetHighestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[0].Bar1))
      {
         flag=true;
      }
   }
   ...
   if(wboem.TriangleBreakoutDirection==directionByIntValue.ShortIntValue)
   {
      if(Close[0] < GetLowestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[0].Bar1))
      {
         flag=true;
      }
   } 
...
bool GetTrianglePointOneNotViolatedFlag()
{
   ...
   if(wboem.TriangleBreakoutDirection==directionByIntValue.LongIntValue)
   {
      if(GetLowestPrice(NULL,wbm.WaveBreakTimeframe,0,tboo[0].Bar1-1)>tboo[0].Price1)
      {
         flag=true;
      }
   }
   ...
   if(wboem.TriangleBreakoutDirection==directionByIntValue.ShortIntValue)
   {
      if(GetHighestPrice(NULL,wbm.WaveBreakTimeframe,0,tboo[0].Bar1-1)<tboo[0].Price1)
      {
         flag=true;
      }
   } 
...
void UpdateWaveBreakOrderEntryManager()
{
   ...
   wboem.CurrentOpenInPositionFlag=GetCurrentOpenInPositionFlag();
   ...
   wboem.TrianglePointOneNotViolatedFlagOn=GetTrianglePointOneNotViolatedFlag();
   wboem.PriceExtremeReachedFlag = GetPriceExtremeReachedFlag();
   ...
   //if(BreakoutPriceFlagEnabled && wboem.BreakoutPriceFlag){longTradeFlag++;}
   //if(TriangleBreakoutDirectionEnabled && wboem.TriangleBreakoutDirection == directionByIntValue.LongIntValue){longTradeFlag++;}
   //if(CurrentOpenInPositionFlagEnabled && wboem.CurrentOpenInPositionFlag){longTradeFlag++;}
   //if(CurrentCandleColorCorrectFlagEnabled && wboem.CurrentCandleColorCorrectFlag){longTradeFlag++;}
   //if(PreviousCandleColorCorrectFlagEnabled && wboem.PreviousCandleColorCorrectFlag){longTradeFlag++;}
   //if(TrianglePointOneNotVioloatedFlagOnEnabled && wboem.TrianglePointOneNotViolatedFlagOn){longTradeFlag++;}
   //if(PriceExtremeReachedFlagEnabled && wboem.PriceExtremeReachedFlag){longTradeFlag++;}
   //if(PivotLineTypeEnabled && wboem.PivotLineType==directionByIntValue.LongIntValue){longTradeFlag++;}
   ...
   VerboseLog("shortTrade: ",shortTradeFlag," wboem.ThreeEMATrendDirection: ",wboem.ThreeEMATrendDirection);
   
   
   //if(BreakoutPriceFlagEnabled && wboem.BreakoutPriceFlag){shortTradeFlag++;}
   //if(TriangleBreakoutDirectionEnabled && wboem.TriangleBreakoutDirection == directionByIntValue.ShortIntValue){shortTradeFlag++;}
   //if(CurrentOpenInPositionFlagEnabled && wboem.CurrentOpenInPositionFlag){shortTradeFlag++;}
   //if(PreviousCandleColorCorrectFlagEnabled && wboem.PreviousCandleColorCorrectFlag){shortTradeFlag++;}
   //if(CurrentCandleColorCorrectFlagEnabled && wboem.CurrentCandleColorCorrectFlag){shortTradeFlag++;}
   //if(TrianglePointOneNotVioloatedFlagOnEnabled && wboem.TrianglePointOneNotViolatedFlagOn){shortTradeFlag++;}
   //if(PriceExtremeReachedFlagEnabled && wboem.PriceExtremeReachedFlag){shortTradeFlag++;}
   //if(PivotLineTypeEnabled && wboem.PivotLineType==directionByIntValue.ShortIntValue){shortTradeFlag++;}
   ...
   if(wboem.WaveBreakOrderEntryManagerFlagOn)
   {
      ...
      if(CurrentOpenInPositionFlagEnabled){debugObject.Add(" Current Open In Position Flag Enabled: " + CurrentOpenInPositionFlagEnabled + "\n");}
      ...
      if(TrianglePointOneNotVioloatedFlagOnEnabled){debugObject.Add(" Triangle Point One Not Violoated Flag On Enabled: " + TrianglePointOneNotVioloatedFlagOnEnabled + "\n");}
      if(PriceExtremeReachedFlagEnabled){debugObject.Add(" Price Extreme Reached Flag Enabled: " + PriceExtremeReachedFlagEnabled + "\n");}
      ...
      if(CurrentOpenInPositionFlagEnabled){debugObject.Add(" Current Open In Position Flag: " + wboem.CurrentOpenInPositionFlag + "\n");}
      ...
      if(TrianglePointOneNotVioloatedFlagOnEnabled){debugObject.Add(" Triangle Point One Not Violated Flag On: " + wboem.TrianglePointOneNotViolatedFlagOn + "\n");}
      if(PriceExtremeReachedFlagEnabled){debugObject.Add(" Price Extreme ReachedFlag: " + wboem.PriceExtremeReachedFlag + "\n");}
      ...
      for(int x=currentBar;x<Bars-4;x++)
      {
            if(lastClusterType !=directionByIntValue.LongIntValue)
            {
               if(GetXCandlesGreenFlagCount(x,x+2,wbm.WaveBreakTimeframe)==3)
               {
                  ...
                  if(ppoIndex>0)
                  {
                     CreateShortArrow("PTT_ARROW_" + ppoIndex, ppo[ppoIndex].PivotBar);
                  }
            ...
            if(lastClusterType !=directionByIntValue.ShortIntValue)
            {
               if(GetXCandlesRedFlagCount(x,x+2,wbm.WaveBreakTimeframe)==3)
               {
                  ...
                  if(ppoIndex>0)
                  {
                     CreateLongArrow("PTT_ARROW_" + ppoIndex, ppo[ppoIndex].PivotBar);
                  }
...
bool CreateLongArrow(string objectName,int barsBack)
{
   bool result = false;
   int time = Time[barsBack];
   double price = Low[barsBack]-80*Point;
...
bool CreateShortArrow(string objectName,int barsBack)
{
   bool result = false;
   int time = Time[barsBack];
   double price = High[barsBack]+480*Point;
