//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.010 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Sat Jan 26 23:51:00 EST 2019
//+------------------------------------------------------------------+
...
extern bool BreakoutPriceFlagEnabled = false;
extern bool TriangleBreakoutDirectionEnabled = false;
extern bool CurrentOpenInPositionFlagEnabled = false;
extern bool CurrentCandleColorCorrectFlagEnabled = false;
extern bool PreviousCandleColorCorrectFlagEnabled = false;
extern bool TrianglePointOneNotVioloatedFlagOnEnabled = false;
extern bool PriceExtremeReachedFlagEnabled = false;
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.010 EA", 9, "Tahoma", LabelColor);
...
//+------------------------------------------------------------------------------------------+
//+ Phoenix Trend Trader Library v0.010
//+
//+------------------------------------------------------------------------------------------+
//
...
bool GetPriceExtremeReachedFlag()
{
   ...
   if(wboem.TriangleBreakoutDirection==directionByIntValue.LongIntValue)
   {
      if(Close[0] > GetHighestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[currentTriangleIndexNumber].Bar1))
      {
         flag=true;
      }
   }
   ...
   if(wboem.TriangleBreakoutDirection==directionByIntValue.ShortIntValue)
   {
      if(Close[0] < GetLowestPrice(NULL,wbm.WaveBreakTimeframe,1,tboo[currentTriangleIndexNumber].Bar1))
      {
         flag=true;
      }
   } 
...
void UpdateWaveBreakOrderEntryManager()
{
   ...
   if(CurrentOpenInPositionFlagEnabled){longTradeFlag = longTradeFlag && (wboem.CurrentOpenInPositionFlag);}
   ...
   if(CurrentOpenInPositionFlagEnabled){shortTradeFlag = shortTradeFlag && (wboem.CurrentOpenInPositionFlag);}
