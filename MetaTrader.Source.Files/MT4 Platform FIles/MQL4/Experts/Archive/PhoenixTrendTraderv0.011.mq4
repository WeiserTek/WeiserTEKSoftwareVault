//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.011 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Thu Jan 31 23:08:00 EST 2019
//+------------------------------------------------------------------+
...
extern bool Debug_PriceExtremeNotReachedFlagOn = false;
...
extern bool PriceExtremeNotReachedFlagEnabled = false;
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.011 EA", 9, "Tahoma", LabelColor);
...
void UpdateWaveBreakOrderEntryManager()
{
   ...
   //if(PriceExtremeNotReachedFlagEnabled && wboem.PriceExtremeNotReachedFlag){longTradeFlag++;}
   ...
   if(wboem.WaveBreakOrderEntryManagerFlagOn)
   {
      ...
      if(CurrentOpenPastPreviousOpenFlagEnabled){debugObject.Add(" Current Open In Position Flag Enabled: " + CurrentOpenPastPreviousOpenFlagEnabled + "\n");}
      ...
      if(CurrentOpenPastPreviousOpenFlagEnabled){debugObject.Add(" Current Open In Position Flag: " + wboem.CurrentOpenPastPreviousOpenFlag + "\n");}
