//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.012 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Sat Feb 02 17:06:00 EST 2019
//+------------------------------------------------------------------+
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.012 EA", 9, "Tahoma", LabelColor);
...
void ProcessOrderHandler()
{
   ...
   int orderEntryDirection = GetOrderEntryDirection();
   int cmd;

   if(marketPosition == directionByIntValue.NeutralIntValue)
   {
      if(orderEntryDirection == directionByIntValue.LongIntValue)
      {
         comment = "Long Entry";
         magicNumber = 1000;
      ...
      if(orderEntryDirection == directionByIntValue.ShortIntValue)
      {
         comment = "Short Entry";
         magicNumber = 2000;
...
void CloseOrdersOnDirectionChange()
{
   ...
   int marketPosition = sqGetMarketPosition();
   int pivotLineType = wboem.PivotLineType;
   
   if(marketPosition == directionByIntValue.LongIntValue && pivotLineType != directionByIntValue.LongIntValue)
   {
      closeAllFlag = true;
   }
