//+------------------------------------------------------------------+
//| PhoenixTrendTraderv0.015 EA
//|
//|    Generated by StrategyQuant EA Wizard version 2.0.1
//|    Generated at Sat Mar 30 23:19:00 EDT 2019
//+------------------------------------------------------------------+
...
int init() {
   ...
   if(DisplayInfoPanel) {
      ...
      ObjectSetText("line1", "PhoenixTrendTraderv0.015 EA", 9, "Tahoma", LabelColor);
...
int start() {
   ...
   //--------------------------------------
   // Close Long On Profit 
   if (((sqGetMarketPosition() == 1) 
      && (sqGetOpenPLInMoney(0) >= 100)))
   {
      // Custom action
...
//+------------------------------------------------------------------------------------------+
//+ Phoenix Trend Trader Library v0.015
//+
//+------------------------------------------------------------------------------------------+
//
